...
public class PathFilteringPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        includedPathRegexesPanel = new info.gianlucacosta.easypmd7.ide.options.regexes.RegexesPanel();
        excludedPathsPanelContainer = new javax.swing.JPanel();
        excludedPathRegexesPanel = new info.gianlucacosta.easypmd7.ide.options.regexes.RegexesPanel();
    ...
    private info.gianlucacosta.easypmd7.ide.options.regexes.RegexesPanel excludedPathRegexesPanel;
    private javax.swing.JPanel excludedPathsPanelContainer;
    private info.gianlucacosta.easypmd7.ide.options.regexes.RegexesPanel includedPathRegexesPanel;
