...
import info.gianlucacosta.easypmd7.ThrowableExtensions;
...
class ScanError implements ScanMessage {
    ...
    public String getTaskType() {
        return "info.gianlucacosta.easypmd7.ide.tasklist.ScanError";
    }

    @Override
    public String getAnnotationType() {
        return "info.gianlucacosta.easypmd7.ide.annotations.ScanError";
    }
