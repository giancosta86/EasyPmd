...
class ScanViolation implements ScanMessage {
    ...
    public String getTaskType() {
        switch (priority) {
            case HIGH:
                return "info.gianlucacosta.easypmd7.ide.tasklist.High";
            case MEDIUM_HIGH:
                return "info.gianlucacosta.easypmd7.ide.tasklist.MediumHigh";
            case MEDIUM:
                return "info.gianlucacosta.easypmd7.ide.tasklist.Medium";
            case MEDIUM_LOW:
                return "info.gianlucacosta.easypmd7.ide.tasklist.MediumLow";
            case LOW:
                return "info.gianlucacosta.easypmd7.ide.tasklist.Low";
            default:
    ...
    public String getAnnotationType() {
        switch (priority) {
            case HIGH:
                return "info.gianlucacosta.easypmd7.ide.annotations.High";
            case MEDIUM_HIGH:
                return "info.gianlucacosta.easypmd7.ide.annotations.MediumHigh";
            case MEDIUM:
                return "info.gianlucacosta.easypmd7.ide.annotations.Medium";
            case MEDIUM_LOW:
                return "info.gianlucacosta.easypmd7.ide.annotations.MediumLow";
            case LOW:
                return "info.gianlucacosta.easypmd7.ide.annotations.Low";
            default:
                throw new RuntimeException(String.format("Unexpected priority value: '%s'", priority));
        }
    }
